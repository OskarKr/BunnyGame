...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.shuriken0);
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.shuriken2);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.shuriken3);
        random = new Random();
        resetPosition();
    }
